...
After resolving, read the repository's configured feedback-loop contract and run every applicable check for the reconciliation. If a check fails, fix what you can; if you cannot fix it, flag the exact failure clearly in the comment.
