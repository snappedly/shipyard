...
- Shipyard's integration branch is `staging`. Its issue closure point is merge to
  `staging` plus required CI success. A decision or implementation issue is not
...
| Shipyard issue closure                | Configured: merge to `staging` and required Shipyard CI success.                                                                                                                                                                                                           | Shipyard coordinator; applies only to Shipyard issues.                                      |
